...
using ClinicFlow.WebUI.ViewModels.Specialty;
...
namespace ClinicFlow.WebUI.Controllers
{
    public class SpecialtiesController : BaseController
    {
        ...
        #region ========================= Get =========================
        public async Task<IActionResult> Index(SpecialtyFilterDTO filter)
        {
            ...
            var viewModel = new SpecialtyIndexVM
            {
                PagedResult = getAllResult.Data ?? new PagedResult<SpecialtyDTO>(),
                Filter = filter,
            };
        ...
        public async Task<IActionResult> Search(string search)
        {
            ...
            return Json(result.Data ?? Enumerable.Empty<SpecialtySearchDTO>());
        }
        #endregion
