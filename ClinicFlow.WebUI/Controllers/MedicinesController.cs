...
using ClinicFlow.WebUI.ViewModels.Medicine;
...
namespace ClinicFlow.WebUI.Controllers
{
    public class MedicinesController : BaseController
    {
        ...
        #region ========================= Get =========================
        public async Task<IActionResult> Index(MedicineFilterDTO filter)
        {
            ...
            var viewModel = new MedicineIndexVM
            {
                PagedResult = getAllResult.Data ?? new PagedResult<MedicineDTO>(),
                Filter = filter,
            };
        ...
        public async Task<IActionResult> Search(string search)
        {
            ...
            return Json(result.Data ?? Enumerable.Empty<MedicineSearchDTO>());
        }
        #endregion
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(MedicineDTO DTO)
        {
            if (InvalidModel())
            {
                return View(DTO);
