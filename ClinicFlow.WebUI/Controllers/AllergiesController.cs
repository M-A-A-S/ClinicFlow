...
using ClinicFlow.WebUI.ViewModels.Allergy;
...
namespace ClinicFlow.WebUI.Controllers
{
    public class AllergiesController : BaseController
    {
        ...
        #region ========================= Get =========================
        public async Task<IActionResult> Index(AllergyFilterDTO filter)
        {
            ...
            var viewModel = new AllergyIndexVM
            {
                PagedResult = getAllResult.Data ?? new PagedResult<AllergyDTO>(),
                Filter = filter,
            };
        ...
        public async Task<IActionResult> Search(string search)
        {
            ...
            return Json(result.Data ?? Enumerable.Empty<AllergySearchDTO>());
        }
        #endregion
        ...
        {
            return View(new AllergyDTO());
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create(AllergyDTO DTO)
        {
            if (InvalidModel())
            {
                return View(DTO);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(AllergyDTO DTO)
        {
            if (InvalidModel())
            {
                return View(DTO);
